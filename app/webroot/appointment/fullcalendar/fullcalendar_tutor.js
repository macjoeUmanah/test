...
var viewlink = htmlEscape('http://learnwp.me/calendars/events_view_cal/'+'/'+event.event_id);
		titleHtml =
			...
			'</span>';
		var deletelink = htmlEscape('http://learnwp.me/calendars/events_delete/'+event.event_id);
		return '<div class="fc-content fc-day-grid-event fc-event fc-start fc-end">' +
					(isRTL ?
						titleHtml + ' ' + timeHtml : // put a natural space in between
						timeHtml + ' ' + titleHtml   //
						) +
				'<div style="float:right;"><span style="color:red;float:left;padding-left: 4px;"><span onClick="editfunction(\''+htmlEscape(event.url)+'\');"><img src="http://learnwp.me/theme/fullcalendar/pencil.png"></span></span><span style="color:red;float:left;padding-left: 4px;"><span onClick="confirmfunction(\''+deletelink+'\');"><img src="http://learnwp.me/theme/fullcalendar/cross.png"></span></span></div><div class="clearfix"></div></div>' +
				(isResizable ?
...
$.extend(TimeGrid.prototype, {
	...
	renderSegHtml: function(seg, disableResizing) {
		...
		var titleHtmls =	'<span class="fc-title" onClick="viewfunction(\''+htmlEscape(viewlink)+'\');">' +
