            ...
            <div class="col-md-4">
              <div class="price-column-container border-active">
                ...
                <div class="price-table-footer">
					<a class="nyroModal" href="<?php echo SITE_URL; ?>/users/purchase_subscription_numbers/<?php echo $monthlydetail['MonthlyNumberPackage']['id']?>"><button type="button" class="btn blue btn-outline sbold uppercase price-button">Confirm</button></a>
                </div>
              </div>
            </div>
			<?php } ?>
