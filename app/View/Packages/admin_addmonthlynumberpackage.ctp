...
<?php echo $this->Form->create('MonthlyNumberPackage',array('style'=>'width:98%'));?>
	<fieldset>
		<legend><?php echo('Add Secondary Number Packages'); ?></legend>
	<?php 
...
'Zimbabwe'=>'Zimbabwe');
		...
		echo $this->Form->input('country',array('type' =>'select','div'=>false,'label'=>'<strong>Country</strong>', 'options'=>$Option4));
		echo '<br/><br/>';
		 echo '<div class="input select"><label for="PackageUser">User</label>';
        echo '<select name="data[MonthlyNumberPackage][username]">';
