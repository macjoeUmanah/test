...
<div class="packages index" style="margin-right:20px">
	<h2><?php echo('List Secondary Number Packages');?></h2>
	<table cellpadding="0" cellspacing="0">
	<tr>
            <th><?php echo $this->Paginator->sort('plan_id','Plan ID');?></th>
			<th><?php echo $this->Paginator->sort('package_name');?></th>
			<th><?php echo $this->Paginator->sort('amount');?></th>
			<th><?php echo $this->Paginator->sort('total_secondary_numbers','# of Secondary Numbers');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $package['MonthlyNumberPackage']['username']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'editmonthlynumberpackage', $package['MonthlyNumberPackage']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'monthlynumberdelete', $package['MonthlyNumberPackage']['id']), array('class' => 'delete'), sprintf(__('Are you sure you want to delete?', true))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
