		...
		<h3 class="page-title"> Auto Responders
			...
			<div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-repeat font-red"></i><span class="caption-subject font-red sbold uppercase">Auto Responders</span>
                                    </div>
                                    <!--<div class="tools">
							...
							<!--<tbody>-->
								<tr <?php echo $class;?>>
									...
									<td> <?php echo $responder['Responder']['days'];?>&nbsp; </td>
                                                                        <td><?php if($responder['Responder']['ishour']==2){
										echo 'Hours';
										}else{
										echo 'Days';
									}?>&nbsp;
...
<?php
echo $this->Html->link('<i class="icon-note" style="font-size:14px"></i>',array('action'=>'edit',$responder['Responder']['id']),array('class'=> 'btn green btn-sm','escape'=> false,'title'=>'Edit','style'=>'margin-right:0px')); ?>
...
<?php
echo $this->Html->link('<i class="icon-trash" style="font-size:14px"></i>',array('action'=>'delete',$responder['Responder']['id'],'0'),array('class'=> 'btn red-thunderbird btn-sm','escape'=> false,'title'=>'Delete'), sprintf(__('Are you sure you want to delete this responder?', true))); ?>
									</td>
								</tr>
								<?php endforeach; ?>
							<!--</tbody>-->
