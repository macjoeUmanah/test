 ...
 */
	function __construct(View $View, $settings = array()) {
		...
		/*if(App::import(array('type' => 'File', 'name' => 'PaypalIpn.PaypalIpnConfig', 'file' => CONFIG .'paypal_ipn_config.php'))){
    	    $this->config = new PaypalIpnConfig();
        }
        else {
    	    //Import from paypal plugin configuration
    	    App::import(array('type' => 'File', 'name' => 'PaypalIpn.PaypalIpnConfig', 'file' => APP . 'Config' . DS . 'paypal_ipn_config.php'));
    	    $this->config = new PaypalIpnConfig();
        }*/
 ...
 */
	function __submitButton($options = array()) {
		$options = is_array($options) ? $options : array('class'=>'btn blue','label' => $options);
