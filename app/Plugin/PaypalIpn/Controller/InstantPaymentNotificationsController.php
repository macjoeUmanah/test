 ...
 */
	...
	public function purchase_credit($package_id){
	  if($this->InstantPaymentNotification->isValid($_POST)){
      $notification = $this->InstantPaymentNotification->buildAssociationsFromIPN($_POST);
      $this->InstantPaymentNotification->saveAll($notification);
    ...
    public function __processTransactionCredit($txnId, $package_id){
    $this->log("Processing Trasaction: $txnId",'paypal');
    ...
    public function purchase_subscription($package_id){
	  if($this->InstantPaymentNotification->isValid($_POST)){
      $notification = $this->InstantPaymentNotification->buildAssociationsFromIPN($_POST);
      $this->InstantPaymentNotification->saveAll($notification);
	...
	public function purchase_subscription_numbers($package_id){
		if($this->InstantPaymentNotification->isValid($_POST)){
			$notification = $this->InstantPaymentNotification->buildAssociationsFromIPN($_POST);
			$this->InstantPaymentNotification->saveAll($notification);
	...
	public function __processTransactionSubscriptionnumbers($txnId, $package_id){
		$this->log("Processing Trasaction: $txnId",'paypal');
		$this->log("package id: $package_id",'paypal');
		//Put the afterPaypalNotification($txnId) into your app_controller.php
    ...
    public function __processTransactionSubscription($txnId, $package_id){
        $this->log("Processing Trasaction: $txnId",'paypal');
        $this->log("package id: $package_id",'paypal');
        //Put the afterPaypalNotification($txnId) into your app_controller.php
